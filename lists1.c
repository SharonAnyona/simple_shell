...
/**
 * list_len - It Determines the length of linked list
 ...
 *
 * Return: Give match node or null
 */
 ...
 * @node: It is a pointer to the node
 *
 * Return: Give index of node or -1
 */
